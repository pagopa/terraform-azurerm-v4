...
| <a name="input_elastic_agent_version"></a> [elastic\_agent\_version](#input\_elastic\_agent\_version) | Version of the elastic agent to be installed | `string` | `"9.3.2"` | no |
...
| <a name="input_enabled_metric_collection"></a> [enabled\_metric\_collection](#input\_enabled\_metric\_collection) | Controls the enabled metric collection for various components | <pre>object({<br/>    k8s           = bool<br/>    system        = bool<br/>    elastic_agent = bool<br/>  })</pre> | <pre>{<br/>  "elastic_agent": true,<br/>  "k8s": true,<br/>  "system": true<br/>}</pre> | no |
...
| <a name="input_output_idle_connection_timeout"></a> [output\_idle\_connection\_timeout](#input\_output\_idle\_connection\_timeout) | Idle connection timeout for the elastic agent output | `string` | `"3s"` | no |
| <a name="input_output_worker"></a> [output\_worker](#input\_output\_worker) | Number of workers for the elastic agent output | `number` | `1` | no |
