...
| <a name="input_diagnostic_settings_enabled"></a> [diagnostic\_settings\_enabled](#input\_diagnostic\_settings\_enabled) | Is diagnostic settings enabled? | `bool` | `false` | no |
...
| <a name="output_private_fqdn"></a> [private\_fqdn](#output\_private\_fqdn) | The fully qualified domain name (FQDN) of the private DNS CNAME record. |
