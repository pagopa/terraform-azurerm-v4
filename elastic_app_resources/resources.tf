...
resource "elasticstack_kibana_alerting_rule" "alert" {
  ...
  lifecycle {
   ...
   precondition {
      condition     = lookup(each.value, "apm_metric", null) != null  && try(each.value.apm_metric.metric, "") != "anomaly" ? each.value.apm_metric.filter != null && each.value.apm_metric.anomaly.threshold != null : true
