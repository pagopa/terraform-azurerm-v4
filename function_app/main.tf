...
resource "azurerm_linux_function_app" "this" {
  ...
  storage_account_name          = var.default_storage_enable ? module.storage_account[0].name : ""
  storage_account_access_key    = var.default_storage_enable ? module.storage_account[0].primary_access_key : ""
