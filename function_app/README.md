...
| <a name="module_storage_account_durable_function"></a> [storage\_account\_durable\_function](#module\_storage\_account\_durable\_function) | ../storage_account | n/a |
...
| <a name="input_app_service_plan_type"></a> [app\_service\_plan\_type](#input\_app\_service\_plan\_type) | (Required) The type of App Service Plan. Possible values are 'internal', 'external' | `string` | n/a | yes |
...
| <a name="output_user_identity_principal"></a> [user\_identity\_principal](#output\_user\_identity\_principal) | A list of User Assigned Managed Identity IDs assigned to this Function App. |
<!-- END_TF_DOCS -->
