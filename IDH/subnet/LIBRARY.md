...
| cstar | dev |  container_app_environment | Prefix length: 24, delegation: - |
...
| cstar | prod |  container_app_environment | Prefix length: 24, delegation: - |
...
| cstar | uat |  container_app_environment | Prefix length: 24, delegation: - |
