...
| <a name="input_minimum_tls_version"></a> [minimum\_tls\_version](#input\_minimum\_tls\_version) | (Optional) The minimum TLS version required for SSL. Possible values are '1.0', '1.1', and '1.2'. Defaults to '1.2'. | `string` | `null` | no |
