...
| <a name="input_geo_replication"></a> [geo\_replication](#input\_geo\_replication) | (Optional) Map of geo replication settings | <pre>object({<br/>    enabled                     = bool<br/>    name                        = optional(string, null)<br/>    subnet_id                   = optional(string, null)<br/>    location                    = optional(string, null)<br/>    location_short              = optional(string, null)<br/>    private_dns_registration_ve = optional(bool, false)<br/>  })</pre> | <pre>{<br/>  "enabled": false,<br/>  "location": null,<br/>  "location_short": null,<br/>  "name": null,<br/>  "private_dns_registration_ve": false,<br/>  "subnet_id": null<br/>}</pre> | no |
