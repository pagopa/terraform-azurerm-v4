...
| Name | Description |
|------|-------------|
| <a name="output_azure_client_id"></a> [azure\_client\_id](#output\_azure\_client\_id) | The Application (client) ID generated by Azure |
| <a name="output_azure_client_secret"></a> [azure\_client\_secret](#output\_azure\_client\_secret) | The Client Secret value generated by Azure |
<!-- END_TF_DOCS -->
