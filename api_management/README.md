...
| <a name="input_diagnostic_operation_name_format"></a> [diagnostic\_operation\_name\_format](#input\_diagnostic\_operation\_name\_format) | The format of the operation name in the logs. Possible values are Name, Url | `string` | `null` | no |
