...
| <a name="input_force_upgrade_enabled"></a> [force\_upgrade\_enabled](#input\_force\_upgrade\_enabled) | (Optional) If set to true, cluster will be forced to upgrade even if the latest version of the control plane and agents is not available. | `string` | `null` | no |
