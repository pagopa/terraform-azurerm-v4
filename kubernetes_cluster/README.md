...
| <a name="input_ama_log_collection_settings"></a> [ama\_log\_collection\_settings](#input\_ama\_log\_collection\_settings) | Container Insights (ama-logs) log collection settings. stdout and stderr can use different namespace exclusions, and coredns system pod logs are collected by default. | <pre>object({<br/>    enable_log_collection_cm    = optional(bool, true)<br/>    stdout_exclude_namespaces   = optional(list(string), [])<br/>    stderr_exclude_namespaces   = optional(list(string), [])<br/>    collect_system_pod_logs     = optional(list(string), ["kube-system:coredns"])<br/>    enable_stdout_logs          = optional(bool, true)<br/>    enable_stderr_logs          = optional(bool, true)<br/>    containerlog_schema_version = optional(string, "v2")<br/>    enable_multiline_logs       = optional(bool, true)<br/>    filter_using_annotations    = optional(bool, false)<br/>    collect_env_vars            = optional(bool, true)<br/>    enrich_container_logs       = optional(bool, false)<br/>    collect_all_kube_events     = optional(bool, false)<br/>  })</pre> | `{}` | no |
