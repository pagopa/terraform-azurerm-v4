...
| <a name="input_grafana_api_key"></a> [grafana\_api\_key](#input\_grafana\_api\_key) | (Optional) Grafana Managed Service Account key | `string` | `""` | no |
| <a name="input_grafana_url"></a> [grafana\_url](#input\_grafana\_url) | (Optional) Grafana Managed url | `string` | `"https://PLACEHOLDER.com"` | no |
