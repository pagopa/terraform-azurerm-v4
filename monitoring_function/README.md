...
| <a name="input_enabled_sythetic_dashboard"></a> [enabled\_sythetic\_dashboard](#input\_enabled\_sythetic\_dashboard) | Enabled sythetic dashboard on grafana | `bool` | `false` | no |
| <a name="input_grafana_api_key"></a> [grafana\_api\_key](#input\_grafana\_api\_key) | Grafana Managed Service Account key | `string` | `""` | no |
| <a name="input_grafana_url"></a> [grafana\_url](#input\_grafana\_url) | Grafana Managed url | `string` | `""` | no |
