...
| <a name="input_scale_in"></a> [scale\_in](#input\_scale\_in) | (Optional) A scale\_in block as defined below. This is used to configure the behavior of scale-in operations for the Virtual Machine Scale Set. | <pre>object({<br/>    force_deletion_enabled = bool<br/>    rule                   = string<br/>  })</pre> | `null` | no |
